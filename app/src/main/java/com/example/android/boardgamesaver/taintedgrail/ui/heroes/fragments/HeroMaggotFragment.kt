...
class HeroMaggotFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        heroesViewModel.maggotName.observe(viewLifecycleOwner, Observer { heroName.text = it })
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(sectionNumber: Int): HeroMaggotFragment {
            return HeroMaggotFragment().apply {
