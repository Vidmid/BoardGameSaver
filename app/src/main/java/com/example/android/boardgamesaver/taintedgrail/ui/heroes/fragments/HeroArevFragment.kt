...
class HeroArevFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        heroesViewModel.arevName.observe(viewLifecycleOwner, Observer { heroName.text = it })
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(sectionNumber: Int): HeroArevFragment {
            return HeroArevFragment().apply {
